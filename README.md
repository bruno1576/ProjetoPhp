...
- Quando o formulário for enviado, uma mensagem deve ser exibida para o usuário final:
	...
	##Instruções
	**Para que o sistema funcione ,é preciso ter conexão a internet,pois o banco de dados é acessado remotamente,o sistema inclui
    as informaçoes diretamente do banco de dados e preenche as paginas,tambem foi colocado um sistema de pesquisa por palavras chaves
    ele traz as paginas que possuem a palavra digitada,e lista elas com os determinados links para cada uma delas...**
    **Para acessar de um banco local,sera preciso fazer alterações no arquivo config.php....**
